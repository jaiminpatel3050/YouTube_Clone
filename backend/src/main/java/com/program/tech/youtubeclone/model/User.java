package com.program.tech.youtubeclone.model;
...
public class User {
    ...
    private Set<String> likedVideos = ConcurrentHashMap.newKeySet(); //to make sure collection is threadsafe, thats why we can not use HashSer
    private Set<String> disLikedVideos = ConcurrentHashMap.newKeySet(); //to make sure collection is threadsafe, thats why we can not use HashSer
